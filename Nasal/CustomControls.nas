var custom_control = func {
  if ( getprop("sim/model/flash2a/custom-control") == "normal" ) {
    ...
    setprop("controls/flight/elevator-trim_custom", getprop("controls/flight/elevator-trim") * (-1) );
    ...
    setprop("controls/flight/elevator-trim_custom", getprop("controls/flight/elevator-trim") );
